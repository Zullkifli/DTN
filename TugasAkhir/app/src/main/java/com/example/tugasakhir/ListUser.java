...
public class ListUser extends ListActivity {
	...
	public void onListItemClick(ListView list, View view, int position, long id){
	    Intent i=new Intent(ListUser.this, Profil.class);
	...
	public boolean onOptionsItemSelected(MenuItem item){
        ...
        case R.id.add:
		    ...
		    int row = c.getCount();
		    	...
		    	//	startActivity(new Intent (this, Detailuser.class));
        	return true;
        default:
	...
	class drvAdapter extends CursorAdapter{
		drvAdapter (Cursor c){super(ListUser.this, c);}
		@Override
	...
	static class drvHolder{
		...
		void populateFrom(Cursor c, dbuser helper){
			txtnamalkp.setText("Nama : "+helper.getnama_pengguna(c));
			txtdeskripsilkp.setText("Email  : "+helper.getemail(c)+", Tlp : "+helper.gettelepon(c)+"\nUsername : "+helper.getusername(c)+"\nPassword : "+helper.getpassword(c));
	...
	public void cekDatabase(){
		...
		int row = c.getCount();
		if (row==0){
			//helper.insertuser(waktu.getText().toString(), tag.getText().toString(),pesan.getText().toString(),status.getText().toString(),keterangan.getText().toString());				
		//	helper.insertuser("20 Desember 2020 13:00", "Butuh Bantuan", "Proses","USR01","-");
		}
	}
